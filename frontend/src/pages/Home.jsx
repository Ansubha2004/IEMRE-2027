  ...
  return (
    <section id="Home" className="relative scroll-mt-[130px] h-[calc(100vh-6.4rem)] w-[100wh]">
      ...
      <div className="relative oswald-text z-[1]  w-full h-full bg-black/40  flex flex-col justify-center items-center box-border px-[3%] py-[3%]">
        ...
        <p className="text-[4rem] font-bold sekuya-regular text-[#FFE156] text-shadow-[7px_7px_0px_rgba(0,0,0,0.5)]">IEMRE-2026</p>
        ...
        <p className="text-yellow-200 text-shadow-[1px_2px_3px_rgba(0,0,0)]">Department of Electrical Engineering (EE) and Electrical & Electronics Engineering (EEE) </p>
        <p className="text-yellow-200 text-shadow-[1px_2px_3px_rgba(0,0,0)]">Institute of Engineering & Management, Kolkata</p>
        <br />
        <p className="font-bold text-green-200 text-[1.5rem] text-shadow-[1px_2px_0px_rgba(0,0,0)] oswald">12th - 14th September, 2026 (Hybrid Mode)</p>
      </div>
    </section>
  );
}
